...
class CurrentState: NSObject, NSCoding {
    ...
    required convenience init(coder aDecoder: NSCoder){
        ...
        let usedItems = aDecoder.decodeObject(forKey: PropertyKey.usedItemsKey) as! [String];
        ...
        self.usedItems.append(contentsOf: usedItems);
    ...
    func encode(with aCoder: NSCoder) {
        aCoder.encode(usedItems, forKey: PropertyKey.usedItemsKey);
